                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('client_designation') ? ' has-danger' : '' }}">
                                            <textarea
                                                ...
                                                required>{{ old('client_designation') }}</textarea>
                                            @if ($errors->has('client_designation'))
                                                <span id="client_designation-error" class="error text-danger"
                                                    for="input-client_designation">{{ $errors->first('client_designation') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
