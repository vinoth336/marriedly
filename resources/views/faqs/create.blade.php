                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('question') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('contact_person') ? ' is-invalid' : '' }}" name="question" id="input-contact_person" type="text" placeholder="{{ __('Question') }}" value="{{ old('question') }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('answer') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('answer') ? ' is-invalid' : '' }}" name="answer" id="answer" type="email" placeholder="{{ __('Answer') }}" required >{{ old('answer') }}</textarea>
